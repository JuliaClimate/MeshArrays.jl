...
begin
	...
	ll=polygons.LineSplitting.regroup([polygons.LineSplitting.split(polygons.LineString(a),lon0) for a in l])
end
...
manifest_format = "2.0"
project_hash = "86bc72ea56adab1ec1f34d1f993564877082b7da"
